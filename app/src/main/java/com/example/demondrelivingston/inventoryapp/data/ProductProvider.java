...
public class ProductProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.demondrelivingston.inventoryapp/product/#" will map to the
        // integer code {@link #PRODUCT_ID}. This URI is used to provide access to ONE single row
        // of the products table.
        //
        // In this case, the "#" wildcard is used where "#" can be substituted for an integer.
        // For example, "content://com.example.demondrelivingston.inventoryapp/product/3" matches, but
        // "content://com.example.demondrelivingston.inventoryapp/product" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                //This will perform a query on the products table where the _id equals and returns a
    ...
    /**
     * Insert a product into the database with the given content values. Return the new URI
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        //Check if price provided is valid, check that it's greater that or equal to $0
        Integer price = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_PRICE);
        if (price != null && price < 0) {
            throw new IllegalArgumentException("Product requires valid price");
        }

        //Check if the quantity provided is valid, check that quantity is greater than or equal to 0
        Integer quantity = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_AMOUNT);
